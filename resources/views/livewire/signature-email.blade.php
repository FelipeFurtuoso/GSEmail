<div class="h-screen overflow-hidden flex items-center flex justify-center" style="background: #edf2f7;">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input wire:change="info_Signature" wire:model="name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="grid-first-name" type="text" placeholder="Mário Gazin">
                ...
                <div class="md:w-1/2 px-3">
                    ...
                    <input wire:change="info_Signature" wire:model="office" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-last-name" type="text" placeholder="Presidente">
                </div>
            </div>
            <div class="-mx-3 md:flex mb-6">
            ...
            <div class="-mx-3 md:flex mb-2">
                ...
                <div class="md:w-1/2 px-3">
                    ...
                    <div wire:model="empresa" class="relative">
                        <select wire:change="select_layout"   class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" id="grid-state">
                        <option value=""></option>    
        ...
        <livewire:layout-gazin :empresa="$empresa">
